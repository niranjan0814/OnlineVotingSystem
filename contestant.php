...
if(isset($_GET['delete'])){
    ...
    mysqli_query($con, "DELETE FROM contestant WHERE CID=$id"); // Corrected the DELETE query
    header('location:maincontestant.php');
...
<div class="contestant-display">
   <table class="contestant-display-table">
      ...
      <tr>
         ...
         <td>
         <a href="contestant_update.php?edit=<?php echo $row['CID']; ?>" > <button class="editebtn">Edit</button>  </a>
         <a href="maincontestant.php?delete=<?php echo $row['CID']; ?>" ><button class="deletebtn">Delete</button>  </a>
         </td>
      </tr>
   <?php } ?>
   </table>
...
if(isset($_POST['update_details'])){
    ...
    $update = "UPDATE contestant SET CName='$cname', Email='$email', Phone=$phone WHERE CID=$id";
